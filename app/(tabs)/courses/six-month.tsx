...
import { supabase, SixMonthCourse } from '@/lib/supabase';

export default function SixMonthCoursesScreen() {
  const router = useRouter();
  const [courses, setCourses] = useState<SixMonthCourse[]>([]);
    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.introSection}>
          <Text style={styles.introTitle}>Six-Month Courses</Text>
          <Text style={styles.introDescription}>
            Our comprehensive six-month programs provide in-depth training and hands-on experience.
            Perfect for those seeking professional-level skills and certification.
          </Text>
        </View>
        ...
        <View style={styles.coursesList}>
          {courses.map((course) => (
            <TouchableOpacity
              ...
              onPress={() => router.push(`/courses/${course.id}?type=six-month`)}>
